...
if ( isset( $_REQUEST[ 'btnSubmit' ] ) ) {
	...
	if ( $result->num_rows > 0 ) {
		...
		if ( password_verify($_POST[ 'psw' ],$rows[ 'pwd' ]) ) {
			if ( $rows['block']==1) echo "<script> alert('Account blocked!!!') </script>";
			else $_SESSION[ 'login' ] = $rows['uid'];

		} else echo "<script> alert('Password incorrect!!!') </script>";
	}
	else echo "<script> alert('Email incorrect or does not exist!!!') </script>";
}
...
<head>
	...
	<title>James Furlinn | Login</title>
	<!-- Bootstrap -->
...
<body>
	...
	if ( isLogined() ) {
		...
		header('location:http://localhost:'.$_SERVER['SERVER_PORT'].'/PRJ_Sem_2.1/');
		...
		<div class="row" id="menu">
			<div class="container" id="menu-flex">
				...
				<div class="cart offset-1 col-3 offset-md-0 col-md-2">
					...
					<div class="col-4 col-lg-3 icon">
						<a href="adlogin.php" title="Ad Sign in"><i class="far fa-user"></i></a>
					</div>
				</div>
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-12 loginbox wow fadeInUp">
				<form action="login.php" method="post">
					<div class="col-lg-12 col-md-12 col-12 logintitle">SIGN IN</div>
					...
					<div class="col-lg-12 col-md-12 col-12 info-signin">
						...
						<button type="submit" name="btnSubmit" id="loginbtn" class="col-5">Sign in</button><br>
