...
//query
$sql_sp = "SELECT * FROM ds_sanpham where maloai='22' LIMIT $from_page, $limit_page";
//echo $sql_sp;
...
<div class="row">
	...
	<div class="product col-12 col-md-4" onClick="show_pr_detail('<?php
		...
		<p>
			<b>
				<?php echo $array_product["tensp"] ?>
			</b><br>$
			<?php echo $array_product["gia"] ?>
		</p>
		<!--</a>-->
	</div>
	<?php
...
<!--
<div class="container-fluid" id="inner-add" id="hide">
