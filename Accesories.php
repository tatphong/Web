...
<head>
	...
	<title>James Furlinn | Men | Accesories</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="container-fluid wow fadeInUp">
		<div class="row">
			<div class="bannerlist col-12 clearfix">
				<img src="list Men/Accesories/accesories1.jpg" alt="">
			</div>
		</div>
	</div>
	<!--boxlink-->
	...
	<div class="container wow fadeInUp">
		...
		<div class="row">
			<div class="dropdown d-none d-md-block offset-md-9 col-md-3">
				Filter:
				<select>
	...
	<!--img-suit-->
	<?php
	include('php/chia_so_trang_accesories_m.php')
	?>
	<!-- FOOTER -->
	...
	<script src="js/menwomen.js"></script>
