...
<head>
	...
	<title>James Furlinn | Men | Shirts</title>
	<!-- Bootstrap -->
...
<body>
	...
	<div class="container-fluid">
		<div class="row wow fadeInUp">
			<div class="bannerlist banner col-12 clearfix">
				<img src="list Men/Shirts/shirt2.jpg" alt="">
			</div>
		</div>
	</div>
	<!--boxlink-->
	...
	<?php
	include('php/chia_so_trang_shirt_m.php')
	?>
