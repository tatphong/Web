...
<html lang="en">
  <head>
    ...
    <title>James Furlinn | Shape Of Beige</title>
    <!-- Bootstrap -->
	...
	<link href="css/SOB.css" rel="stylesheet">
...
<div class="row" >	
	...
	<div class="firstbanner banner wow fadeInDown col-12">
		<img src="img/desktop-imgshadesd.st.jpg" class="img-fluid">
		<img src="img/sob1.jpg" class="img-fluid">
		<img src="img/sob2.jpg" class="img-fluid">
		<img src="img/sob3.jpg" class="img-fluid">
	...
	<div class="row">
		<div class="col-12 product-bst">
			...
			<div class="text col-7">
				<div class="col-1 wow fadeInLeft">
					<div class="col-12 color-box"></div>
					<br><img src="img/join.png" class="img-fluid col-md-10 d-none d-md-block">
				</div>
				<div class="col-11 txt  wow fadeInLeft">
					<a href="#"><img src="img/look1-look1.st.jpg" class="img-fluid col-12"></a>
				</div>
			</div>
			
			<div class="text text-1 col-5">
				<div class="col-12 txt wow fadeInLeft" id="txt-1">
					<h2>PRE-FALL 19<br>
						<font color="#a47241">SHAPE OF BEIGE</font>
					</h2>
					
					<p>
						 Looks made from refreshing<br class="d-md-block d-none"> hues of brown and camel. <br>
					</p>
					
					<a href="details.php"><img src="img/look2-look2.st.jpg" class="d-md-block d-none col-10"></a>
				</div>
			</div>
...
<div class="container">
	<div class="row">
		<div class="col-12 product-bst row-3">
			...
			<div class="col-md-6 col-12 wow fadeInLeft">
				<img src="img/look5-look5.st (1).jpg" class="img-fluid">
				<br><br>
			</div>
			
			<div class="col-md-6 col-12 wow fadeInRight">
				
				<img src="img/look6-look6.jpg" class="img-fluid" id="img-sob">
			</div>
	...
	<br>
	<div class="row">
		<div class="col-12 product-bst row-4">
		
			<div class="col-md-6 col-12 wow fadeInLeft">
				<img src="img/look3-look3.st.jpg" class="img-fluid">
			</div>
			<div class="col-md-6 d-md-block d-none wow fadeInRight">
				<img src="img/234.jpg" class="img-fluid" id="img-sob-2">
			</div>
	...
	<br>
	<div class="row">
		<div class="col-12 product-bst row-5">
		
			<div class="col-md-6 col-12 wow fadeInLeft">
				<img src="img/look7-look7.st.jpg" class="img-fluid">
			</div>
			<br>
			<div class="col-md-6 col-12 wow fadeInRight">
				<img src="img/look8-look8.st.jpg" class="img-fluid shoes-sob">
			</div>
		...
		<div class="col-12 wow fadeInUp">
			...
			<div class="col-12 wow fadeInUpBig">
				<div class="col-6 col-md-4 col-lg-4 pr">
					<a href="details.php"><img src="img/5511500704_6_1_1.jpg" class="img-fluid">
					<p align="center">
				...
				<div class="col-6 col-md-4 col-lg-4 pr">
					<a href="details.php"><img src="img/4432450707_6_1_1.jpg" class="img-fluid">
					<p align="center">
				...
				<div class="col-6 col-md-4 col-lg-4 d-none d-md-block pr">
					<a href="details.php"><img src="img/3057426710_6_1_1.jpg" class="img-fluid">
					<p align="center">
				...
				<div class="col-6 col-md-4 col-lg-4 pr">
					<a href="details.php"><img src="img/5512500704_6_1_1.jpg" class="img-fluid">
					<p align="center">
				...
				<div class="col-6 col-md-4 col-lg-4 pr">
					<a href="details.php"><img src="img/4432452707_6_1_1.jpg" class="img-fluid">
					<p align="center">
				...
				<div class="col-6 col-md-4 col-lg-4 d-none d-md-block pr">
					<a href="details.php"><img src="img/6917402250_6_1_1.jpg" class="img-fluid">
					<p align="center">
				...
				<div class="col-6 col-md-4 col-lg-4 pr">
					<a href="details.php"><img src="img/2225002001_1_1_1.jpg" class="img-fluid">
					<p align="center">
				...
				<div class="col-6 col-md-4 col-lg-4 pr">
					<a href="details.php"><img src="img/2229002001_1_1_1.jpg" class="img-fluid">
					<p align="center">
				...
				<div class="col-6 col-md-4 col-lg-4 d-none d-md-block pr">
					<a href="details.php"><img src="img/2200002001_1_1_1.jpg" class="img-fluid">
					<p align="center">
